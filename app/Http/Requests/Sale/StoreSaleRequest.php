...
class StoreSaleRequest extends FormRequest
{
    ...
    {
        return [
            'items.required' => 'Debe enviar al menos un item de venta.',
            'items.min' => 'Debe enviar al menos un item de venta.',
            'point_of_sale.required_if' => 'El punto de venta es requerido cuando se solicita factura.',
        ];
    }
}
